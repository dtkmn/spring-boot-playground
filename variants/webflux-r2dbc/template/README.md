...
under `src/test/java`, using the existing customer tests as examples. Keep request handling non-blocking and compose Reactor publishers rather than calling `block()` or manually subscribing.
