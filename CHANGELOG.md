...
### Fixed
- Complete Kafka Streams startup on Boot 4 with Jackson 3 and Boot-managed Kafka dependencies, add context and trade-aggregation regression tests, and document the migration
